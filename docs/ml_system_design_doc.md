...
#### Сравнение метрик базового и улучшенного подходов:

| Метрика | Базовый подход | Улучшенный подход |
|---------|---------------|------------------|
| mAP(50-95) | 41.2 | 60.7 |
| HOTA | 68.5 | 68.5 |
| MOTA | 69.3 | 76.1 |

Отличие состояло лишь в наличии легковесного классификатора на то продавец человек или нет, поэтому на HOTA метрику это никак не влияет, однако остальные метрики значительно изменились. (однако улучшенная модель не выведена в прод из-за неоконченной разметки данных и дообучения модели детекции продавца)

P.S. тест проводился только на 2 размеченных видео поэтому результаты не окончательные
